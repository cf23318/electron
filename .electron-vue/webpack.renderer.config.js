...
let rendererConfig = {
  ...
  plugins: [
    ...
    // 引入vjsPlayer播放器时修正静态资源引入路径问题
    new ReplaceInFileWebpackPlugin([{
      dir: 'dist/electron',
      files: ['static/player/manifest.js', 'renderer.js'],
      rules: [{
        search: '/static/player/',
        replace: './static/player/'
      }]
    }]),
  ...
  resolve: {
    alias: {
      ...
      'ipc-types': path.join(__dirname, '../src/main/ipcTypes'),
      'store-types': path.join(__dirname, '../src/renderer/store/types'),
